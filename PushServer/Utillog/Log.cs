...
namespace Util.Logs
{
    ...
    public class Log : LogBase<LogContent>
    {
        ...
        private static ILog GetLog(string logName, string @class)
        {
            ...
            var providerFactory =  new Util.Logs.NLog.LogProviderFactory();
            var format =  Util.Logs.Formats.ContentFormat.Instance;
            var context = NullLogContext.Instance;
       ...
       // public static readonly ILog CommonInstance => 
    }
}
