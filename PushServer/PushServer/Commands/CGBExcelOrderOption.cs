...
namespace PushServer.Commands
{
    ...
    public class CGBExcelOrderOption : OrderOptionBase
    {
        public override string Name => OMS.Models.OrderSource.CGB;
        ...
        protected  List<OrderEntity> ResolveOrders(DataTable excelTable,string file, List<OrderEntity> items)
        {
            ...
            //        if (foo != null)
            //        {
            //            Util.Logs.Log.GetLog(nameof(CGBExcelOrderOption)).Error($"订单{foo.OrderSn}已经存在");
            //            continue;
            ...
            //            else //异常订单
            //            {
            //                InsertOrUpdateExceptionOrder(file, orderItem, db, ExceptionType.PhoneNumIsNull);
            //                continue;
            //            }
            //            //查找商品字典
            ...
            //                if (bar == null || string.IsNullOrEmpty(bar.ProductCode))
            //                {
            //                    Util.Logs.Log.GetLog(nameof(CGBExcelOrderOption)).Error($"订单文件：{file}中平台商品：{productName}未找到");
            ...
            //            if (foo == null)
            //            {
            //                Util.Logs.Log.GetLog(nameof(CGBExcelOrderOption)).Error($"订单文件：{file}中平台商品名称：{productName}对应系统商品未找到");
            //                Util.Logs.Log.GetLog(nameof(CGBExcelOrderOption)).Debug($"订单文件：{file}中平台商品名称：{productName}对应系统商品未找到.order:{Util.Helpers.Json.ToJson(orderItem)}");
            //                continue;
            //            }
            ...
            //                {
            //                    Util.Logs.Log.GetLog(nameof(CGBExcelOrderOption)).Error($"订单文件：{file}中平台商品：{productName}未找到");
            //                    Util.Logs.Log.GetLog(nameof(CGBExcelOrderOption)).Debug($"订单文件：{file}中平台商品：{productName}未找到.order:{Util.Helpers.Json.ToJson(item)}");
            //                    continue;
            //                }
            //            }
            //            if (string.IsNullOrEmpty(bar.ProductNameInPlatform))
            ...
            //            {
            //                Util.Logs.Log.GetLog(nameof(CGBExcelOrderOption)).Error($"订单文件：{file}中平台商品名称：{productName}对应系统商品未找到");
            //                Util.Logs.Log.GetLog(nameof(CGBExcelOrderOption)).Debug($"订单文件：{file}中平台商品名称：{productName}对应系统商品未找到.order:{Util.Helpers.Json.ToJson(item)}");
            //                continue;
            //            }
