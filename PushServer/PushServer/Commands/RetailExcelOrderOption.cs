...
namespace PushServer.Commands
{
    ...
    public class RetailExcelOrderOption : OrderOptionBase
    {
        public override string Name => OMS.Models.OrderSource.Retail;
        private string NameDesc = Util.Helpers.Reflection.GetDescription<OrderSource>(OrderSource.Retail);
