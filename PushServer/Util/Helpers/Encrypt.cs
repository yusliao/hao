...
namespace Util.Helpers {
    ...
    public static class Encrypt {
        ...
        public static string Md5By32(byte[] datas)
        {
            var md5 = new MD5CryptoServiceProvider();
            string result;
            try
        ...
        public static string Md5By32(System.IO.Stream datas)
        {
        ...
        public static string Md5By16(byte[] datas)
        {
            var md5 = new MD5CryptoServiceProvider();
            string result;
            try
        ...
        /// </summary>
        /// <param name="value">值</param>
        public static string SHA1By16(string value)
        {
            return SHA1By16(value, Encoding.UTF8);
        }
        ...
        /// <param name="value">值</param>
        /// <param name="encoding">字符编码</param>
        public static string SHA1By16(string value, Encoding encoding)
        {
            return SHA1(value, encoding, 4, 8);
        }

        /// <summary>
        /// SHA1加密
        /// </summary>
        private static string SHA1(string value, Encoding encoding, int? startIndex, int? length)
        {
            if (string.IsNullOrWhiteSpace(value))
                return string.Empty;
        ...
        /// </summary>
        /// <param name="value">值</param>
        public static string SHA1By32(string value)
        {
            return SHA1By32(value, Encoding.UTF8);
        }
        ...
        /// <param name="value">值</param>
        /// <param name="encoding">字符编码</param>
        public static string SHA1By32(string value, Encoding encoding)
        {
            return SHA1(value, encoding, null, null);
        }
