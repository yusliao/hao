...
namespace Util.Webs.Clients {
    ...
    public interface IRequest<out TRequest> where TRequest : IRequest<TRequest> {
        ...
        TRequest AddMulitpartFile(List<byte[]> datas, int blocknum, long blockSize, string fileName, string contentType, long totalSize, long blockCount);
        /// <summary>
        /// 添加Json参数
        /// </summary>
        /// <param name="value">值</param>
        ...
        /// 获取结果
        /// </summary>
        Task<string> ResultAsync(CancellationToken cancellationToken);
    }
}
