...
namespace Util.Webs.Clients {
    ...
    public abstract class HttpRequestBase<TRequest> where TRequest : IRequest<TRequest> {
        ...
        private List<MulitpartFile> _mulitpartFiles = new List<MulitpartFile>();
        ...
        /// 获取结果
        /// </summary>
        public async Task<string> ResultAsync(CancellationToken cancellationToken)
        {
            SendBefore();
        ...
        private HttpRequestMessage CreateRequestMessage() {
            var message = new HttpRequestMessage {
                ...
                Content = _httpMethod==HttpMethod.Get?null:CreateHttpContent()//GET请求不能给content赋值
            };
        ...
        private HttpContent CreateHttpContent() {
            ...
            switch( contentType ) {
                ...
                case "multipart/form-data":
                    return CreateMulitpartFileContent(_mulitpartFiles);
            }
        ...
        private HttpContent CreateByteArrayContent()
        {
            
            var bc = new ByteArrayContent(null);
            bc.Headers.ContentDisposition = new System.Net.Http.Headers.ContentDispositionHeaderValue("form-data");
            bc.Headers.ContentDisposition.FileName = _params["filename"];
            bc.Headers.ContentDisposition.Name = $"{_params["filename"]}{_params["blocknum"]}";
            bc.Headers.ContentDisposition.Parameters.Add(new System.Net.Http.Headers.NameValueHeaderValue("blocknum", _params["blocknum"]));
            bc.Headers.ContentDisposition.Parameters.Add(new System.Net.Http.Headers.NameValueHeaderValue("blocknum", _params["blocknum"]));
            bc.Headers.ContentDisposition.Parameters.Add(new System.Net.Http.Headers.NameValueHeaderValue("blocksize", _params["blocksize"]));
            bc.Headers.ContentType = new System.Net.Http.Headers.MediaTypeHeaderValue("application/octet-stream");
